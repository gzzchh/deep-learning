...
# 训练模型
def train(trainSet, validateSet, batchSize, epochs, learningRate, wtDecay):
    # 选择设备
    # 载入数据并分割batch
...
# 超参数可自行指定
model = train(trainDataSet, testDataSet, batchSize=64, epochs=100, learningRate=0.001, wtDecay=0.3)

# 保存模型
torch.save(model, 'DeepEmotionModel.pk1')
